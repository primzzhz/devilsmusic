...
async def playthis(client: Client, message_: Message):
    ...
    if message_.chat.id in tgcalls.pytgcalls.active_calls:
        ...
        chat_id=message_.chat.id,
        photo="https://telegra.ph/file/a8f7867a55f2fa1907feb.jpg",
        caption=f"Don't Forget to add @trashzz_bot in group to listen your song.",
         ) 
...
async def p(client: Client, message_: Message):
    ...
    m = await client.send_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                 [     InlineKeyboardButton("* Youtube *", url=link)]]
        ),
        parse_mode="markdown",
    )
    os.remove("final.png")
